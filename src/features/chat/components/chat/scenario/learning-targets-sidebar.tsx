...
import {LearningTargetCard} from "@/features/chat/components/chat/scenario/learning-target-card";
...
export function LearningTargetsSidebar({ targets, targetsStatus }: LearningTargetsSidebarProps) {
    return (
        <div className="flex flex-col gap-4 p-6 w-80 bg-background/80 backdrop-blur-sm border-l border-border overflow-y-auto">
